...
fs.writeFileSync('system_flowchart.svg', svg);
console.log('Flowchart saved as system_flowchart.svg');

// Also create a PNG version using a simple HTML file that can be opened in browser
...
fs.writeFileSync('system_flowchart.html', html);
console.log('HTML version saved as system_flowchart.html');
